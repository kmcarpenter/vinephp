...
abstract class MetaModelCollection extends Model implements \Countable, \IteratorAggregate, \ArrayAccess
{
    ...
    {
        $key = self::$modelKey;
        return $this->data->$key[$offset] = $value;
    }
